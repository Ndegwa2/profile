        ...
        <section id="about" className="py-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 text-slate-400 leading-relaxed text-lg">
            <div>
              ...
              <p>
                When I am not coding or managing logistics, you can find me on the basketball court, where my competitive spirit earned me the Brookside Award for athletic performance, or involved in environmental initiatives.
              </p>
            </div>
