            ...
            <div className="bg-slate-900/50 p-8 rounded-2xl border border-white/5 relative group overflow-hidden">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex gap-3">
                  ...
                  <span><strong className="text-slate-300">Leadership:</strong> Driving high-trust, fast-paced projects through proactive communication and Agile principles.</span>
                </li>
              </ul>
            </div>
          </div>
